...
M.highlights = {
    ...
    StatusLine = { fg = p.bg0, bg = p.bg2 },
    StatusLineTerm = { fg = p.fg, bg = p.bg0 },
    ...
    VertSplit = { fg = p.bg5 },
    Visual = { bg = p.visual },
    VisualNOS = { fg = p.none, bg = p.visual, underline = true },
    ...
    Type = { fg = p.blue },
    Structure = { fg = p.red } + styles.keywords,
    StorageClass = { fg = p.red } + styles.keywords,
    Identifier = { fg = p.pink } + styles.identifiers,
    ...
    MiniStatuslineModeCommand = { fg = p.bg0, bg = p.green, bold = false },
    MiniStatuslineModeInsert = { fg = p.bg0, bg = p.purple, bold = false },
    MiniStatuslineModeNormal = { fg = p.bg0, bg = p.blue, bold = false },
    MiniStatuslineModeOther = { fg = p.bg0, bg = p.red, bold = false },
    MiniStatuslineModeReplace = { fg = p.bg0, bg = p.red, bold = false },
    MiniStatuslineModeVisual = { fg = p.bg0, bg = p.yellow, bold = false },
    ...
    -- python
    pythonAttribute = { link = "Function" },
    pythonBuiltin = { link = "@variable.builtin" },
    ...
    ["@function.builtin"] = { link = "Function", default = true },
    ...
    ["@namespace"] = { link = "Purple2", default = true },
    ...
    ["@variable.builtin"] = { fg = p.blue, default = true },
    ...
    LspDiagnosticsDefaultWarning = { fg = p.green + gamma(0.5) },
    ...
    CmpItemKindVariable = { fg = p.purple2 },
    CmpItemKindConstant = { fg = p.purple2 },
    CmpItemKindReference = { fg = p.purple2 },
    CmpItemKindValue = { fg = p.purple2 },
    ...
    RenderMarkdownH6 = { fg = p.orange, bold = true },
    RenderMarkdownH1Bg = {},
    RenderMarkdownH2Bg = { fg = p.purple, bold = true },
    RenderMarkdownH3Bg = { fg = p.blue, bold = true },
    RenderMarkdownH4Bg = { fg = p.green, bold = true },
    RenderMarkdownH5Bg = { fg = p.yellow, bold = true },
    RenderMarkdownH6Bg = { fg = p.orange, bold = true },
    markdownHeadingDelimiter = { fg = p.purple },
    ...
    NvimTreeFileDeleted = { link = "GitSignsDelete" },
    NvimTreeFileDirty = { link = "GitSignsChange" },
    NvimTreeFileMerge = { link = "GitSignsChange" },
    NvimTreeFileNew = { fg = p.blue },
    NvimTreeFileRenamed = { fg = p.red },
    NvimTreeFileStaged = { fg = p.purple2 },
    NvimTreeFolderIcon = { fg = p.purple2 },
    NvimTreeFolderName = { link = "@variable" },
    NvimTreeGitDeleted = { link = "GitSignsDelete" },
    NvimTreeGitDirty = { fg = p.red },
    NvimTreeGitIgnored = { fg = p.grey },
    NvimTreeGitMerge = { fg = p.git_merge },
    NvimTreeGitNew = { fg = p.git_add },
    NvimTreeGitRenamed = { fg = p.git_rename },
    NvimTreeGitStaged = { fg = p.git_stage },
    NvimTreeImageFile = { fg = p.fg },
    NvimTreeNormal = { link = "@variable" },
